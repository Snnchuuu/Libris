...
public class WishListDAO {
    ...
    public boolean addItem(int userId, int itemId) {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            // Duplicate entry means item is already in the wish list
    ...
    /**
     * Returns all items in a member's wish list as LibraryItem objects.
     * Uses JOIN with library_items to get full item details.
     * @param userId ID of the member
     * @return List of LibraryItem objects in the wish list
     */

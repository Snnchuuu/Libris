...
public class StartupHooks {
    ...
    /** wishlist_items tablosunu yoksa oluşturur (basit migrasyon). */
    private void ensureWishlistTable() {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            System.out.println("[StartupHooks] wishlist_items table ready.");
        } catch (SQLException e) {
            System.err.println("[StartupHooks] wishlist_items create failed: " + e.getMessage());
        }
    }
}
